...
import { InnerDragSelectProps, forOptionActionKey, Option } from './BottomRightDragSelectCommon';
import { useClickToSelect, useDragToSelect } from './BottomRightDragSelectHook';
...
const bottomRightDragSelectClass = computed(() => ({
  'bottom-right-drag-select': true,
  'bottom-right-drag-select--disabled': props.disabled,
}));
...
<template>
  <div ref="containerRef" class="bottom-right-drag-select__wrapper">
    <div ref="contentRef" :class="bottomRightDragSelectClass" style="position: relative" @click="onContentRefClick">
      <slot />
