...
import { InnerDragSelectProps, forOptionActionKey, Option } from './BottomLeftDragSelectCommon';
import { useClickToSelect, useDragToSelect } from './BottomLeftDragSelectHook';
...
const bottomLeftDragSelectClass = computed(() => ({
  'bottom-left-drag-select': true,
  'bottom-left-drag-select--disabled': props.disabled,
}));
...
<template>
  <div ref="containerRef" class="bottom-left-drag-select__wrapper">
    <div ref="contentRef" :class="bottomLeftDragSelectClass" style="position: relative" @click="onContentRefClick">
      <slot />
